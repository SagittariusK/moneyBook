...
<script src="/resources/_js/calendar/example.js"></script>
<script src="/resources/_js/calendar/helpers.js"></script>
		...
		<tbody>
			<tr ng-repeat="event in vm.events track by $index">
				...
				<td>
					<p class="input-group" style="max-width: 250px">
						<input type="text" class="form-control" readonly
							uib-datepicker-popup="dd MMMM yyyy" ng-model="event.startsAt" is-open="event.startOpen" close-text="Close" >
				...
				<td>
					<p class="input-group" style="max-width: 250px">
						<input type="text" class="form-control" readonly
							uib-datepicker-popup="dd MMMM yyyy" ng-model="event.endsAt" is-open="event.endOpen" close-text="Close">
						<span class="input-group-btn">
